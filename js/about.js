function autoPlayTabs(i, e) {
    var t = 0, o = $(".about__stats-tabs"), s = $(".about__stats-tabs-content"), n = $(".about__stats-tab-runner");
    return e || "undefined" == typeof interval ? (i.each(function (e) {
        $(this).on("changeTab", function () {
            t = e;
            var r = $(this).attr("href"), l = o.find(r);
            i.removeClass("active"), $(this).addClass("active"), s.fadeOut("slow"), setTimeout(function () {
                l.fadeIn("slow")
            }, 300), setPositionOfTbRunner(n, $(this)[0].offsetLeft, $(this).width())
        })
    }), void(interval = setInterval(function () {
        i.eq(t).trigger("changeTab"), t++, "undefined" == typeof i[t] && (t = 0)
    }, 3e3))) : void clearInterval(interval)
}

function setPositionOfTbRunner(i, e, t) {
    i.css({left: Math.ceil(e) + "px", width: Math.ceil(t) + "px"})
}

$(document).ready(function () {
    if ($(".about__stats-tab-counter").each(function () {
        ...
        $(".about__slider-list").slick(i)
    }
    var e, t = $(".about__stats-tab"), o = $(".about__stats-tabs"), s = $(".about__stats-tabs-content"),
        n = $(".about__stats-tabs-head"), r = n.find(".active"), l = $(".about__stats-tab-runner");
    r.length && setPositionOfTbRunner(l, r[0].offsetLeft, r.width()), autoPlayTabs(t, !0), t.on("click", function (i) {
        i.preventDefault(), autoPlayTabs(t, !1), "undefined" != typeof e && clearTimeout(e);
        var n = $(this).attr("href"), r = o.find(n);
        t.removeClass("active"), $(this).addClass("active"), s.fadeOut("slow"), setTimeout(function () {
            r.fadeIn("slow")
        }, 300), setPositionOfTbRunner(l, $(this)[0].offsetLeft, $(this).width()), e = setTimeout(function () {
            autoPlayTabs(t, !0)
        }, 5e3)
    })
});
